...
abstract class ContoBancario(open val name:String, open val lastName:String, open var saldoIniziale:Int = 0){
    ...
    /**
     * n Kotlin, la parola chiave infix serve a permettere di chiamare una funzione in modo più “naturale”,
     * senza usare il punto . e le parentesi.
     * ex: conto1 deposita 150€
     * */
...
fun main() {
    ...
    conto1.preleva(100)
    conto1.stampaSaldo()
    conto1 deposita 150  // qui si usa infix
    conto1.stampaSaldo()
    conto1.preleva(2000)
